...
If you'd like, I can:
- Add a Postman collection export to this repo for quick testing
- Add more unit tests for edge cases (multi-customer input, very large amounts, invalid dates)
- Fix any discrepancy in monthly aggregation (e.g. ensure months are ordered or normalized)

---

README generated by assistant on 2026-04-21
